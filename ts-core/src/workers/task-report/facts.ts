...
export function formatInventoryDeltaFact(facts: TaskReportFacts): string {
...
export function formatRecoverable(recoverable: boolean | null): string {
  if (recoverable === true) {
    return "可恢复";
  }
