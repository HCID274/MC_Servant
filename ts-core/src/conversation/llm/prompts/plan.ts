...
export function createPlanSystemPrompt(input: PlanSystemPromptInput = {}): string {
  ...
  return [
    ...
    '- 主人要求做 wooden_pickaxe / 木镐 后挖 stone / 石头时，必须输出 sandbox_code：await api.bot.ensureWoodenPickaxeEquipped(); await api.bot.mine("stone", count)',
    "- 主人要求准备 stone_pickaxe / 石镐 或具备挖铁前置工具时，必须输出 sandbox_code：await api.bot.ensureStonePickaxeEquipped()",
