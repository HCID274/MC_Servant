...
@dataclass
class AppRuntime:
    """运行时容器：集中管理系统共享的 Bot 实例、任务队列、追踪库及决策状态。"""

    bot_username: str
    bot_manager: Optional[BotManager] = None
    workflow_app: Optional[Any] = None
    checkpointer: Optional[Any] = None # 决策状态记录器
    checkpointer_cm: Optional[Any] = None # 状态记录器上下文
    trace_repo: Optional[TraceRepository] = None # 链路追踪数据库
