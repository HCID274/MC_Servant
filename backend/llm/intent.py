...
| mine | 挖矿采集 | "去挖点铁矿"、"采集钻石"、"挖煤"、"给我弄点木头" |
...
**只要用户明确表达了想让你做某件事，就应该识别为对应的任务意图，而不是 chat。**
请求的语气是否轻松/口语化不影响意图判断。例如：
...
- intent: 意图类型 (build/mine/craft/give/farm/guard/status/cancel/stop/chat/unknown)
- confidence: 置信度 (0.0-1.0)
- entities: 提取的实体信息 (如建筑类型、材料、数量等)
- reason: 简短的识别理由
