...
│           ▼                        ▼                        ▼               │
│  ┌─────────────────┐    ┌─────────────────┐    ┌─────────────────────────┐ │
│  │  LLM Service    │    │  Task Executor  │    │  Blueprint System       │ │
│  │  (通义千问Qwen)  │    │  (神经编译器)    │    │  - litemapy解析         │ │
│  │  - 意图识别      │    │  - Cloud Planner│    │  - WorldEdit集成        │ │
│  │  - 对话管理      │    │  - Edge Trans.  │    │  - 阶段拆分             │ │
│  └─────────────────┘    └────────┬────────┘    └─────────────────────────┘ │
│                                  │                                           │
│                                  ▼                                           │
│                         ┌─────────────────────┐                             │
