...
import com.mcservant.listener.BotBlockCollectionDebugListener;
import com.mcservant.listener.OreVeinListener;
import com.mcservant.listener.PlayerConnectionListener;
import com.mcservant.listener.PlayerInteractListener;
import com.mcservant.listener.TreeFellListener;
...
public class MCServant extends JavaPlugin {
    ...
    private void initListeners() {
        ...
        getServer().getPluginManager().registerEvents(new BotBlockCollectionDebugListener(), this);
        getServer().getPluginManager().registerEvents(new TreeFellListener(), this);
        getServer().getPluginManager().registerEvents(new OreVeinListener(), this);
